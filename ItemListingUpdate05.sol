...
contract ItemListing is Ownable {
    ...
    function editItem(uint256 _itemId, string memory _name, uint256 _price, uint256 _quantity) public isOwner {
    ...
    function deleteItem(uint256 _itemId) public isOwner {
        require(_itemId < sellerItems[msg.sender].length, "Invalid item ID");
